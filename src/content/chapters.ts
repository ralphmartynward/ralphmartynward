...
export const chapters: Chapter[] = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      `Holiday Pirates was the natural step. Still in the broader affiliate world, but now from the partner side, and at a level where I was responsible for outcomes rather than execution. Managing a portfolio of white label travel partnerships that represented 70% of company revenue. Coordinating across legal, dev, editorial, and finance toward shared commercial goals. First proper Scrum environment, first real cross-functional team. The Kayak deeplink project came from a simple observation: the data showed one thing, the editorial team was publishing toward another. Closing that gap added 25% to revenue, and Kayak adopted the pattern across all their white label partners afterwards.`,
      `Then a step up in scale. Veepee, one of France's largest e-commerce platforms, 45 million monthly visitors, a structured product team that did things by the book. Proper UX research, user testing, MVP discipline, backlog grooming with intent. Owning the travel section's frontend revamp meant defining vision and roadmap, building a Marvelapp prototype, running surveys, working in real Scrum cycles with a team of seven. Big company rigour after years of startup improvisation.`,
  ...
  },
  {
    ...
    accent: '#60a5fa',
    paragraphs: [
      `Every previous role had touched data. Every previous side project had used it. But I wanted to go further: not consume outputs, but build the systems that produced them. I did an intensive bootcamp in 2023 to lock in the foundations. Python, machine learning, NLP, neural networks, proper statistical reasoning. Solid technical ground. I won the final project, Purrposterous, a fully automated content pipeline scraping Reddit, classifying with machine learning, generating images and posting to Instagram without human intervention. More importantly I finally had a name for what I'd been doing intuitively the whole time.`,
